...
* [X] Return a single instance, {_SELECT * FROM image WHERE image_id = :imageId_}

* [X] Return multiple instances, selected by {_SELECT * FROM image WHERE note_id = :noteId ORDER BY created ASC_}
